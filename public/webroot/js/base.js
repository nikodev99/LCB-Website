(function ($) {
    ...
    if ($.fn.owlCarousel) {
        const welcomeSlide = $('.hero-slideshow');
    ...
    browserWindow.scroll(function() {
        if (browserWindow.scrollTop() >= 80.7272720336914) {
            $(".contact img").attr('src', '../../webroot/img/icons/logo1.png')
        }else {
            $(".contact img").attr('src', '../../webroot/img/icons/logo.png')
        }
    })
    ...
    $('[data-checked-target]').click(function(){
        let target = $(this).data('checked-target')
        console.log(target)
        if($(this).prop("checked") == true){
            $('[data-checked='+ target +']').show(100)
        }
        else if($(this).prop("checked") == false){
            $('[data-checked='+ target +']').hide(1000)
        }
    });
